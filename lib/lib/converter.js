 ...
 * 
 * @project: https://github.com/Irfanff9/Anya_v2-MD
 * @author: https://github.com/Irfanff9
 */
...
exports.writeExifImg = async (media, metadata) => {
    ...
    if (metadata.packname || metadata.author) {
        ...
        const json = { "sticker-pack-id": "https://github.com/Irfanff9", "sticker-pack-name": metadata.packname, "sticker-pack-publisher": metadata.author, "emojis": metadata.categories ? metadata.categories : ["🤩", "🎊"] };
...
exports.addExif = async (buffer, packname, author, categories = ["🤩", "🎊"], extra = {}) => {
	const img = new webp.Image();
	const json = { 'sticker-pack-id': 'Irfanff9', 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'is-avatar-sticker': 1, ...extra };
